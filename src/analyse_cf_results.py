...
CMIP6_DF = "../data/pkl/cmip6-cf-df.pkl"
...
def global_errors(df):
    ...
    global_errs_by_model.to_csv('../data/csv/global_errors_by_model.csv')
...
def variable_error_types(df):
    ...
    variable_errors_by_id.to_csv('../data/csv/variable_errors.csv')
...
def main():
    ...
    # write_to_json(df)
    # write_release1_to_json(df)

    # interrogate_errors(df)
